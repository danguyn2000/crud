...
export const DELETE_ONE_ITEMS_REQUEST = "DELETE_ONE_ITEMS_REQUEST";
export const DELETE_ONE_ITEMS_SUCCESS = "DELETE_ONE_ITEMS_SUCCESS";
export const DELETE_ONE_ITEMS_FAILURE = "DELETE_ONE_ITEMS_FAILURE";
